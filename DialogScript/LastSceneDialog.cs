...
public class LastSceneDialog : MonoBehaviour
{
    ...
    public string nextSceneName; // Name of the scene to load after dialogues
    ...
    IEnumerator ShowGuideTexts()
    {
        ...
        ChangeScene(); // Change to the next scene after all texts are displayed
    }
